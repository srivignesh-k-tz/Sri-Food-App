...
public class FrenchSheet extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view  = inflater.inflate(R.layout.sheet_french,container, false);
        ...
        like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (context != null) {
                    Toast.makeText(context, "You Liked French Fries", Toast.LENGTH_SHORT).show();
                }
            }
        });
        addcart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MycartFragment.userList.add(new ModelClass(R.drawable.french,"French Fries",increse,(increse*120),1,results,1,resultz,((increse*120)+results+resultz),R.drawable.baseline_delete_forever_24));
    ...
    private void updateSause() {
        ...
        cartamou.setText(String.valueOf((increse * 120) + results+resultz+result));
    }
    ...
    private void updateTopping() {
        ...
        cartamou.setText(String.valueOf((increse * 120) + resultz+result+results));
    }
    ...
    private void updateResult() {
        ...
        cartamou.setText(String.valueOf((increse * 120) + result));
    }
