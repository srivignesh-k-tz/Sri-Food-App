...
import com.example.kupa.second;
import com.google.android.material.bottomsheet.BottomSheetDialogFragment;

public class BurgerSheet extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view  = inflater.inflate(R.layout.sheet_burger,container, false);
        ...
        like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (context != null) {
                    Toast.makeText(context, "You Liked Burger", Toast.LENGTH_SHORT).show();
                }
            }
        });
        addcart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MycartFragment.userList.add(new ModelClass(R.drawable.burger,"Burger",increse,(increse*150),1,results,1,resultz,((increse*150)+results+resultz),R.drawable.baseline_delete_forever_24));
    ...
    private void updateSause() {
        ...
        cartamou.setText(String.valueOf((increse * 150) + results+resultz+result));
    }
    ...
    private void updateTopping() {
        ...
        cartamou.setText(String.valueOf((increse * 150) + resultz+result+results));
    }
    ...
    private void updateResult() {
        ...
        cartamou.setText(String.valueOf((increse * 150) + result));
    }
