...
public class NoodlesSheet extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view  = inflater.inflate(R.layout.sheet_noodles,container, false);
        ...
        like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (context != null) {
                    Toast.makeText(context, "You Liked Chicken Noodles", Toast.LENGTH_SHORT).show();
                }
            }
        });
        addcart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MycartFragment.userList.add(new ModelClass(R.drawable.noodles,"Chicken Noodles",increse,(increse*80),1,results,1,resultz,((increse*80)+results+resultz),R.drawable.baseline_delete_forever_24));
    ...
    private void updateSause() {
        ...
        cartamou.setText(String.valueOf((increse * 80) + results+resultz+result));
    }
    ...
    private void updateTopping() {
        ...
        cartamou.setText(String.valueOf((increse * 80) + resultz+result+results));
    }
    ...
    private void updateResult() {
        ...
        cartamou.setText(String.valueOf((increse * 80) + result));
    }
