...
public class ChickenSheet extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view  = inflater.inflate(R.layout.sheet_chicken,container, false);
        ...
        like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (context != null) {
                    Toast.makeText(context, "You Liked Chicken Lollipop", Toast.LENGTH_SHORT).show();
                }
            }
        });
        addcart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MycartFragment.userList.add(new ModelClass(R.drawable.chick,"Chicken Lollipop",increse,(increse*220),1,results,1,resultz,((increse*220)+results+resultz),R.drawable.baseline_delete_forever_24));
    ...
    private void updateSause() {
        ...
        cartamou.setText(String.valueOf((increse * 220) + results+resultz+result));
    }
    ...
    private void updateTopping() {
        ...
        cartamou.setText(String.valueOf((increse * 220) + resultz+result+results));
    }
    ...
    private void updateResult() {
        ...
        cartamou.setText(String.valueOf((increse * 220) + result));
    }
